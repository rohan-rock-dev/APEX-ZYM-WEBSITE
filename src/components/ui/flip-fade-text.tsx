...
const Word = memo(function Word({
    ...
    const letters = useMemo(() => text.split("").map(char => char === " " ? "\u00a0" : char), [text])
...
export function FlipFadeText({
    ...
    return (
        <div className={cn("flex items-center justify-center min-h-[200px]", className)}>
            <div className={cn("relative flex items-center justify-center", className?.includes("justify-start") ? "justify-start" : "justify-center")} style={{ perspective: "1000px" }}>
                <AnimatePresence mode="wait">
                    <Word
                        ...
                        letterDuration={letterDuration}
                        textClassName={cn(className?.includes("justify-start") ? "justify-start" : "justify-center", textClassName)}
                    />
                </AnimatePresence>
            </div>
        </div>
