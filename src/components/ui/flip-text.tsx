                    ...
                    >
                        {chars.map((char, charIndex) => {
                            ...
                            return (
                                <span
                                    key={charIndex}
                                    className="flip-char-container inline-block relative"
                                    style={
                                        {
                                ...
                                >
                                    {/* Front side of the character */}
                                    <span className="flip-front inline-block select-none">
                                        {char}
                                    </span>
                                    {/* Back side of the character (pre-rotated so it faces the user when parent is flipped) */}
                                    <span className="flip-back absolute inset-0 inline-block select-none">
                                        {char}
                                    </span>
                                </span>
                            );
